...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <div class="kv-zoom-actions">{toggleheader}{borderless}{close}</div>\n' +
                '    </div>\n' +
            ...
            self.defaults = {
                ...
                previewTemplates: {},
                previewSettings: {
                    image: {width: "200px", height: "200px", 'max-width': "100%", 'max-height': "100%"},
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa fa-caret-square-o-up"></i>',
